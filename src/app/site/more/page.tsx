...
import { Bell, ChevronRight, LayoutDashboard, LogOut, UserRound } from "lucide-react";
    ...
    <>
      ...
      <div className="space-y-6 p-5">
        ...
        <div className="space-y-3">
          ...
          <Link href="/site/profile" className={row}><UserRound className="size-5 text-river" />Profile &amp; password<ChevronRight className="ml-auto size-5 text-muted" /></Link>
        ...
        <SignOut className={`${row} w-full text-red-700`}><LogOut className="size-5" />Sign out</SignOut>
      </div>
    </>
  );
}
